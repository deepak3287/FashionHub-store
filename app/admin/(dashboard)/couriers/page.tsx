export default function Page() {
  return (
    <div className="premium-card p-8">
      <h1 className="text-2xl font-black">Courier Management</h1>
      <p className="mt-3 max-w-2xl text-black/60">Add Shiprocket, Delhivery, Blue Dart, DTDC or custom courier partners.</p>
