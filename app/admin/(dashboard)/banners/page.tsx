export default function Page() {
  return (
    <div className="premium-card p-8">
      <h1 className="text-2xl font-black">Banner & Content Management</h1>
      <p className="mt-3 max-w-2xl text-black/60">Manage homepage banners, promotional images and featured sections.</p>
